...
\begin{scope}[shift={(9.6cm,0)},x=1.78cm,y=6.2cm]
 ...
 \draw[capline]
  ...
  --plot[domain={.5+\Btip}:.75,samples=140,variable=\t]
   ({sin(360*\t)-sqrt(max(0,\M*\M-pow(cos(360*\t),2)))},{\t});
 \draw[defectline] plot[domain={1/3}:{7/12},samples=220,variable=\t]
  ({sin(360*\t)},{\t});
 \foreach \x/\y in {.5/.25,1.5/.25,-1.5/.75,-.5/.75}
  {\fill[ink] (\x,\y) circle[radius=1.8pt];}
 \node at (-1.92,.09) {$\nu=0$};
 \node at (0,.09) {$\nu=1$};
 \node[rotate=90] at (-1,.28) {TSc};
 \node[rotate=90] at (1,.12) {TSc};
 \node[rotate=90] at (-1.63,.38) {$(1,2,2/3)$};
 \node[rotate=90] at (1.62,.12) {$(1,2,2/3)$};
 \node[capcolor] at (-.92,.9) {$(1,1,1/2)$};
 \node[capcolor] at (.98,.4) {$(1,1,1/2)$};
